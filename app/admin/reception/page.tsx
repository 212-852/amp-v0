...
import { list_reception_rooms } from '@/lib/admin/reception/room'
...
async function load_rooms(): Promise<
  | { ok: true; rooms: Awaited<ReturnType<typeof list_reception_rooms>> }
  | { ok: false; rooms: [] }
> {
  try {
    return {
      ok: true,
      rooms: await list_reception_rooms({ limit: 50 }),
    }
  } catch (error) {
