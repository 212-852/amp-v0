...
export function resolve_debug_rule(input: {
  ...
  const chat_realtime_always_discord = new Set([
    ...
    'admin_active_chat_message_append_failed',
    ...
    'admin_active_chat_realtime_subscription_status',
    'admin_active_chat_message_append_started',
    'admin_active_chat_message_append_succeeded',
