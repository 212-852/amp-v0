...
//
// Room-list / inbox loading lives in `lib/admin/reception/rooms.ts` and is
// intentionally kept out of this file so a profile-column regression cannot
// break the toggle endpoint.
// ============================================================================
